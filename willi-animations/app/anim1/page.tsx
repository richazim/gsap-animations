...
const Preloader = () => {
    ...
    return (
        <div ref={preloaderRef} className="fixed h-screen w-screen left-0 bottom-0 z-10 bg-[#0e1016] flex justify-center items-center">
            ...
            <div ref={textsContainerRef} className="h-[100px] overflow-hidden text-[14px] text-[#e4ded7] font-extrabold flex items-center justify-center gap-[5px] opacity-0">
    ...
    return (
        <>
            ...
            <div className="h-screen flex justify-center items-center">
                <h1 className="text-[2rem] text-red-400">Welcome</h1>
            </div>
        </>
    )
}
